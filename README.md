...
```powershell
.\.venv\Scripts\python.exe bellman_9489.py
.\.venv\Scripts\python.exe montecarlo_4857.py
.\.venv\Scripts\python.exe temporaldifference_7016.py
.\.venv\Scripts\python.exe sarsa-qlearning_4747.py
.\.venv\Scripts\python.exe samplecode_2934.py
```
